...
public class ColorfulSteamEngineRenderer extends SafeBlockEntityRenderer<ColorfulSteamEngineBlockEntity> {

	public ColorfulSteamEngineRenderer(BlockEntityRendererProvider.Context context) {}

	@Override
	protected void renderSafe(ColorfulSteamEngineBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
