...
public class ColorfulCasingGlassBlock extends CasingBlock {

	protected final DyeColor color;

	public ColorfulCasingGlassBlock(Properties properties, DyeColor color) {
		super(properties);
		this.color = color;
	}
	...
	public boolean skipRendering(BlockState state, BlockState adjacentBlockState, Direction side) {
		return adjacentBlockState.getBlock() instanceof ColorfulCasingGlassBlock || adjacentBlockState.getBlock() instanceof ColorfulGlassEncasedShaftBlock
