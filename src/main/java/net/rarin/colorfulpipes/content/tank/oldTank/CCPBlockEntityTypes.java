...
//	}
//
////	public static final BlockEntityEntry<ColorfulFluidTankBlockEntity> COLORFUL_FLUID_TANKS_TEST = REGISTRATE
////			.blockEntity("colorful_fluid_tank", ColorfulFluidTankBlockEntity::new)
////			.validBlocks(CCPBlocks.COLORFUL_FLUID_TANKS_TEST.toArray())
////			.renderer(() -> ColorfulFluidTankRenderer::new)
////			.register();
//
