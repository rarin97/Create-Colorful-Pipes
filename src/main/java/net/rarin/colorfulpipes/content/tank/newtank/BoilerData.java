...
//
//	public void tick(ColorfulFluidTankBlockEntity controller) {
//		if (!isActive())
//			return;
...
//	}
//
//	public void updateOcclusion(ColorfulFluidTankBlockEntity controller) {
...
//	}
//
//	public boolean evaluate(ColorfulFluidTankBlockEntity controller) {
...
//							attachedEngines++;
//						if (CCPPaletteBlocks.COLORFUL_STEAM_WHISTLES.get(DyeColor.WHITE).has(attachedState)
//								&& ColorfulWhistleBlock.getAttachedDirection(attachedState)
//								.getOpposite() == d)
//							attachedWhistles++;
//					}
//				}
...
//	}
//
//	public void checkPipeOrganAdvancement(ColorfulFluidTankBlockEntity controller) {
...
//								&& ColorfulWhistleBlock.getAttachedDirection(attachedState)
//								.getOpposite() == d) {
//							if (level.getBlockEntity(attachedPos) instanceof ColorfulWhistleBlockEntity wbe)
...
//	}
//
//	public boolean updateTemperature(ColorfulFluidTankBlockEntity controller) {
//		BlockPos controllerPos = controller.getBlockPos();
//		Level level = controller.getLevel();
