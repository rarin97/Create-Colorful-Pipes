...
//
//public class ColorfulFluidTankRenderer extends SafeBlockEntityRenderer<ColorfulFluidTankBlockEntity> {
//
//	public ColorfulFluidTankRenderer(BlockEntityRendererProvider.Context context) {}
//
//	@Override
//	protected void renderSafe(ColorfulFluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
...
//	}
//
//	protected void renderAsBoiler(ColorfulFluidTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
//								  int light, int overlay) {
...
//
//	@Override
//	public boolean shouldRenderOffScreen(ColorfulFluidTankBlockEntity be) {
