...
//import net.rarin.colorfulpipes.CCPDisplaySources;
//import net.rarin.colorfulpipes.CCPMountedStorageTypes;
//import net.rarin.colorfulpipes.CCPPaletteBlocks;
//import net.rarin.colorfulpipes.CCPRegistrate;
...
//	});
//
////	public static final DyedBlockList<ColorfulFluidTankBlockTest> COLORFUL_FLUID_TANKS_TEST = new DyedBlockList<>(color -> {
////		String colorName = color.getSerializedName();
////		return REGISTRATE.block(colorName + "_fluid_tank1", p -> new ColorfulFluidTankBlockTest(p, color))
////				.initialProperties(SharedProperties::copperMetal)
////				.properties(p -> p.noOcclusion().isRedstoneConductor((p1, p2, p3) -> true).mapColor(color.getMapColor()))
////				.transform(pickaxeOnly())
////				.addLayer(() -> RenderType::cutoutMipped)
...
////						.withPool(loots.applyExplosionCondition(CCPBlocks.COLORFUL_FLUID_TANKS.get(color), LootPool.lootPool()
////								.setRolls(ConstantValue.exactly(1.0F))
////								.add(LootItem.lootTableItem(CCPBlocks.COLORFUL_FLUID_TANKS.get(color)))))))
////				.register();
////	});
//
