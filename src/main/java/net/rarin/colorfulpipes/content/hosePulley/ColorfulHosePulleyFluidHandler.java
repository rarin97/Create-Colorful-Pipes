...
public class ColorfulHosePulleyFluidHandler implements IFluidHandler {
    ...
    public int fill(FluidStack resource, IFluidHandler.FluidAction action) {
        ...
        if (diff <= 0) {
            internalTank.drain(-diff, IFluidHandler.FluidAction.EXECUTE);
    ...
    public ColorfulHosePulleyFluidHandler(SmartFluidTank internalTank, FluidFillingBehaviour filler,
