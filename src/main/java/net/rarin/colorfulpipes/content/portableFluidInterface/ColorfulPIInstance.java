...
public class ColorfulPIInstance {
	...
	public ColorfulPIInstance(InstancerProvider instancerProvider, BlockState blockState, BlockPos instancePos, boolean lit) {
		...
		middle = instancerProvider.instancer(InstanceTypes.TRANSFORMED, Models.partial(ColorfulPortableFluidInterfaceRenderer.getMiddleForState(blockState, lit, color)))
				.createInstance();
		top = instancerProvider.instancer(InstanceTypes.TRANSFORMED, Models.partial(ColorfulPortableFluidInterfaceRenderer.getTopForState(blockState, color)))
				.createInstance();
	}
	...
	public void tick(boolean lit) {
		if (this.lit != lit) {
			this.lit = lit;
			DyeColor color = ((ColorfulPortableFluidInterfaceBlock) blockState.getBlock()).color;
			instancerProvider.instancer(InstanceTypes.TRANSFORMED, Models.partial(ColorfulPortableFluidInterfaceRenderer.getMiddleForState(blockState, lit, color)))
