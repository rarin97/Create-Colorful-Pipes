...
public class CCPStress extends ConfigBase {
	...
	private static void assertFromCCP(BlockBuilder<?, ?> builder) {
		if (!builder.getOwner().getModid().equals(ColorfulPipes.ID)) {
			throw new IllegalStateException("Non-Create Colorful Pipes blocks cannot be added to Create Colorful Pipes config.");
		}
	}
