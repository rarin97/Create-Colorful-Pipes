...
public class PumpScenes {
	...
	public static void flow(SceneBuilder builder, SceneBuildingUtil util) {
		...
		scene.world().setBlock(pumpPos, CCPBlocks.COLORFUL_FLUID_PIPES.get(DyeColor.LIGHT_BLUE).get()
		...
		scene.world().modifyBlock(pumpPos, s -> s.setValue(ColorfulPumpBlock.FACING, s.getValue(ColorfulPumpBlock.FACING).getOpposite()), false);
		...
		scene.idle(7);
		scene.world().modifyBlock(pumpPos, s -> s.setValue(ColorfulPumpBlock.FACING, Direction.EAST), true);
...
//		scene.world().showSection(util.select.layersFrom(1), Direction.DOWN);
		...
		scene.world().modifyBlock(pumpPos, s -> s.setValue(ColorfulPumpBlock.FACING, Direction.WEST), false);
		...
		scene.world().setBlock(east, CCPBlocks.COLORFUL_GLASS_FLUID_PIPES.get(DyeColor.PURPLE).getDefaultState()
		...
		BlockState pipeState = CCPBlocks.COLORFUL_FLUID_PIPES.get(DyeColor.PURPLE).getDefaultState()
		...
		scene.world().setBlock(east.north(), pipeState.setValue(ColorfulFluidPipeBlock.NORTH, false)
			.setValue(ColorfulFluidPipeBlock.EAST, false), false);
		scene.world().setBlock(east.south(), pipeState.setValue(ColorfulFluidPipeBlock.SOUTH, false)
			.setValue(ColorfulFluidPipeBlock.EAST, false), false);
		...
		scene.world().setBlock(west.north(), pipeState.setValue(ColorfulFluidPipeBlock.NORTH, false)
			.setValue(ColorfulFluidPipeBlock.WEST, false), false);
		scene.world().setBlock(west.south(), pipeState.setValue(ColorfulFluidPipeBlock.SOUTH, false)
			.setValue(ColorfulFluidPipeBlock.WEST, false), false);
		...
		scene.world().modifyBlock(pumpPos.south(), s -> s.setValue(ColorfulPumpBlock.FACING, Direction.WEST), true);
		scene.world().setKineticSpeed(util.select().everywhere(), 0);
		scene.world().showSection(northPump, Direction.DOWN);
		scene.world().modifyBlock(pumpPos.north(), s -> s.setValue(ColorfulPumpBlock.FACING, Direction.EAST), false);
		scene.idle(4);
		...
		scene.overlay().showControls(util.vector().topOf(pumpPos.north()), Pointing.DOWN, 30).rightClick()
				.withItem(AllItems.WRENCH.asStack());
		scene.idle(7);
		scene.world().modifyBlock(pumpPos.north(), s -> s.setValue(ColorfulPumpBlock.FACING, Direction.WEST), true);
		scene.idle(30);
