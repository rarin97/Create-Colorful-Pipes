...
public class HosePulleyScenes {
	...
	public static void intro(SceneBuilder builder, SceneBuildingUtil util) {
		...
		scene.idle(20);
		scene.world().modifyBlock(util.grid().at(3, 2, 1), s -> s.setValue(ColorfulPumpBlock.FACING, Direction.DOWN), true);
	...
	public static void level(SceneBuilder builder, SceneBuildingUtil util) {
		...
		scene.world().modifyBlock(util.grid().at(3, 2, 1), s -> s.setValue(ColorfulPumpBlock.FACING, Direction.DOWN), false);
		...
		scene.idle(15);
		scene.world().setKineticSpeed(kinetics, -32);
		scene.world().modifyBlock(util.grid().at(3, 2, 1), s -> s.setValue(ColorfulPumpBlock.FACING, Direction.UP), true);
		scene.world().propagatePipeChange(util.grid().at(3, 2, 1));
		scene.idle(16);
		scene.world().setKineticSpeed(kinetics, 0);
	...
	public static void infinite(SceneBuilder builder, SceneBuildingUtil util) {
		...
		scene.world().modifyBlock(pumpPos, s -> s.setValue(ColorfulPumpBlock.FACING, Direction.DOWN), true);
