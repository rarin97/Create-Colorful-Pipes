...
public class SpoutScenes {
	...
	public static void filling(SceneBuilder builder, SceneBuildingUtil util) {
		...
		scene.world().modifyBlock(util.grid().at(2, 3, 3), s -> s.setValue(ColorfulPumpBlock.FACING, Direction.NORTH), false);
		...
		scene.idle(15);
		ElementLink<BeltItemElement> ingot3 = scene.world().createItemOnBelt(beltPos, Direction.SOUTH, bowl);
