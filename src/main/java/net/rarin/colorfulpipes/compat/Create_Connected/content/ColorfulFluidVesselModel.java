...
public class ColorfulFluidVesselModel extends CTModel {

	protected static final ModelProperty<CullData> CULL_PROPERTY = new ModelProperty<>();

	public static ColorfulFluidVesselModel standard(BakedModel originalModel, DyeColor color) {
		return new ColorfulFluidVesselModel(originalModel,
	...
	private ColorfulFluidVesselModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
